...
struct BucketBackendEnvironmentVariables {
    MC_DEFINE_ENV_VAR(bool, MOONCAKE_OFFLOAD_DISABLE_SSD_EVICTION);
    MC_DEFINE_ENV_VAR(bool, MOONCAKE_OFFLOAD_BUCKET_GC_ENABLE);
    MC_DEFINE_ENV_VAR(int64_t, MOONCAKE_OFFLOAD_BUCKET_GC_INTERVAL_MS);
    MC_DEFINE_ENV_VAR(double, MOONCAKE_OFFLOAD_BUCKET_GC_DELETED_RATIO);
    MC_DEFINE_ENV_VAR(double, MOONCAKE_OFFLOAD_BUCKET_GC_HIGH_WATERMARK_RATIO);
    MC_DEFINE_ENV_VAR(int64_t,
                      MOONCAKE_OFFLOAD_BUCKET_GC_MAX_BUCKETS_PER_ROUND);
    MC_DEFINE_ENV_VAR(bool, MOONCAKE_OFFLOAD_BUCKET_GC_MERGE_ENABLE);
